        ...
        <.div(^.className := "container")(
          <.div(
            ...
            <.p(^.className := "text-muted")(
              """
              Mongo-effect is a fully functional library which integrates both the mongo scala driver and fs2 library.
              To get started, include the below in your build.sbt:
            """
            ),
          ...
          <.div(
            ...
            <.pre(^.className := "bg-light text-muted p-3")(
              <.code(
